...
const defaultData: Database = {
  ...
  guildLogs: [
    ...
    },
    {
      id: 'log2',
      guildId: 'guild1',
      type: 'member_appoint_vice',
      operatorId: 'user1',
      targetUserId: 'user2',
      description: '任命 vice_admin 为副会长',
      details: {},
      createdAt: Date.now() - 86400000 * 20,
    },
    {
    ...
    },
    {
      id: 'log4',
      guildId: 'guild1',
      type: 'item_contribute',
      operatorId: 'user2',
      targetUserId: 'user2',
      description: 'vice_admin 贡献了 2 个「暗影法杖」',
      details: { itemName: '暗影法杖', quantity: 2, rarity: 'epic' },
      createdAt: Date.now() - 86400000 * 2,
    },
    {
      id: 'log5',
      ...
      operatorId: 'user1',
      targetUserId: 'user3',
      description: '结算任务「清剿哥布林营地」，player1 获得 150 贡献和 300 公会资金',
      details: { questTitle: '清剿哥布林营地', contribution: 150, funds: 300 },
      createdAt: Date.now() - 86400000 * 2,
    },
    {
      id: 'log6',
